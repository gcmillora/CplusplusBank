...
void timeOnJob(int arvHr, int arvMin, bool arvIsAM, int depHr,
                int depMin, bool depIsAM);
int main(){
    string employeeName;
    int departureHr,departureMin,arrivalMin,arrivalHr;
    bool departureAM,arrivalAM;
    char response,discard,isAM;
    cout<<"This porgram calculates the total time spent by an "
    ...
    while(response=='y'|| response == 'Y'){
        ...
        timeOnJob(arrivalHr,arrivalMin,arrivalAM,departureHr,
                departureMin,departureAM);
